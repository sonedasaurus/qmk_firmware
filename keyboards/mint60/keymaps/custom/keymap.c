...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    KC_ESC,    KC_CAPS,    KC_LALT,    KC_LGUI,    KC_SPC,        KC_SPC, KC_ENT,  LALT(KC_GRV),               KC_LEFT,KC_DOWN,KC_RGHT \
  ),
  [1] = LAYOUT( \
    ...
    XXXXXXX,   _______,    _______,    _______,    KC_BSPC,       KC_BSPC, XXXXXXX, XXXXXXX,                   KC_HOME, KC_PGDN, KC_END \
  )
};
